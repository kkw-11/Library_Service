...
### 배운 점
* DataScientsit로 DataBase를 end-user로서 사용할 때와 다르게 개발자로백엔드 DB 구축 부터 API 설계, 프론트엔드 UI개발까지 모든 영역을 담당하면서 웹서비스 개발의 전체적인 프로세스를 이해하고 사용자가 아니라 엔지니어로서 기술을 바라보는 방법을 배움
